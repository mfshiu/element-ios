...
class MockLiveLocationSharingViewerService: LiveLocationSharingViewerServiceProtocol {
    ...
    private func createFirstUserLiveLocation() -> UserLiveLocation {
        let userAvatarData = AvatarInput(mxContentUri: nil, matrixItemId: "@alice:tprai.org", displayName: "Alice")
    ...
    private func createSecondUserLiveLocation() -> UserLiveLocation {
        let userAvatarData = AvatarInput(mxContentUri: nil, matrixItemId: "@bob:tprai.org", displayName: "Bob")
    ...
    private func createRandomUserLiveLocation() -> UserLiveLocation {
        ...
        let userAvatarData = AvatarInput(mxContentUri: nil, matrixItemId: "@user_\(uuidString):tprai.org", displayName: "User \(uuidString)")
