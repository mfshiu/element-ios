...
@MainActor class AuthenticationRegistrationViewModelTests: XCTestCase {
    ...
    func testMatrixDotOrg() {
        // Given the initial view model configured for tprai.org with some SSO providers.
        let homeserver = defaultHomeserver
        
        // Then the view state should contain a homeserver that matches tprai.org and shows SSO buttons.
    ...
    func testUsernameAvailability() async throws {
        ...
        XCTAssertEqual(context.viewState.usernameFooterMessage, VectorL10n.authenticationRegistrationUsernameFooterAvailable("@bob:tprai.org"),
