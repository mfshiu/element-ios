...
enum MockVoiceBroadcastRecorderScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        let details = VoiceBroadcastRecorderDetails(senderDisplayName: "", avatarData: AvatarInput(mxContentUri: "", matrixItemId: "!fakeroomid:tprai.org", displayName: "The name of the room"))
