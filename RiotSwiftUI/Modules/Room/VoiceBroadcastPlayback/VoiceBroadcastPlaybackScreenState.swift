...
enum MockVoiceBroadcastPlaybackScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        ...
        let details = VoiceBroadcastPlaybackDetails(senderDisplayName: "Alice", avatarData: AvatarInput(mxContentUri: "", matrixItemId: "!fakeroomid:tprai.org", displayName: "The name of the room"))
