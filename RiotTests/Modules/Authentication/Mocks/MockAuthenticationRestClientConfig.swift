...
extension MockAuthenticationRestClient {
    enum Config: String {
        /// A homeserver that mimics tprai.org with both passwords and SSO.
        /// Create the client using https://tprai.org for this configuration.
        case matrix
        ...
        init(url: URL) {
            ...
            case "https://tprai.org", "https://matrix-client.tprai.org":
                self = .matrix
