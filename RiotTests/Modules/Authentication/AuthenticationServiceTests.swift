...
@MainActor class AuthenticationServiceTests: XCTestCase {
    ...
    func testWizardsWhenStartingLoginFlow() async throws {
        ...
        try await service.startFlow(.login, for: "https://tprai.org")
    ...
    func testWizardsWhenStartingRegistrationFlow() async throws {
        ...
        try await service.startFlow(.register, for: "https://tprai.org")
    ...
    func testHomeserverState() async throws {
        ...
        XCTAssertEqual(service.state.homeserver.addressFromUser, "https://tprai.org", "The new address entered by the user should be stored.")
        XCTAssertEqual(service.state.homeserver.address, "https://matrix-client.tprai.org", "The new address discovered from the well-known should be stored.")
    }
    ...
    func testPasswordLogin() async throws {
        ...
        XCTAssertEqual(session.myUserId, "@alice:tprai.org")
    }
    ...
    func testHomeserverViewDataForMatrixDotOrg() {
        // Given a homeserver such as tprai.org.
        let address = "https://matrix-client.tprai.org"
        let addressFromUser = "https://tprai.org" // https is added when sanitising the input.
        ...
        XCTAssertEqual(viewData.address, "tprai.org", "The displayed address should match the address supplied by the user, but without the scheme.")
    ...
    func testHomeserverAddressSanitization() {
        ...
        XCTAssertEqual(sanitizedBasicAddress, "https://tprai.org")
