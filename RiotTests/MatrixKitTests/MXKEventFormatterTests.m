...
- (void)testRenderHTMLStringWithLink
{
    ...
    NSString *html = @"This text contains a <a href=\"https://www.tprai.org/\">link</a>.";
    ...
    [attributedString enumerateAttribute:NSLinkAttributeName
        ...
        if ([value isKindOfClass:NSURL.class])
        {
            ...
            XCTAssertEqualObjects(url, [NSURL URLWithString:@"https://www.tprai.org/"], @"href links should be included in the text.");
            didFindLink = YES;
        }
    }];
...
- (void)testRenderHTMLStringWithLinkInHeader
{
    ...
    NSString *h1HTML = @"<h1><a href=\"https://www.tprai.org/\">Matrix.org</a></h1>";
    NSString *h3HTML = @"<h3><a href=\"https://www.tprai.org/\">Matrix.org</a></h3>";
...
- (void)testRenderHTMLStringWithIFrame
{
    ...
    NSString *html = @"<iframe src=\"https://www.tprai.org/\"></iframe>";
...
- (void)testRenderHTMLStringWithMXReply
{
    ...
    NSString *html = @"<mx-reply><blockquote><a href=\"https://matrix.to/#/someroom/someevent\">In reply to</a> <a href=\"https://matrix.to/#/@alice:tprai.org\">@alice:tprai.org</a><br>Original message.</blockquote></mx-reply>This is a reply.";
    ...
    XCTAssertEqualObjects(plainString, @"In reply to @alice:tprai.org\nOriginal message.\nThis is a reply.",
...
- (void)testRenderHTMLStringWithMXReplyQuotingInvalidMessage
{
    ...
    NSString *html = @"<mx-reply><blockquote><a href=\"https://matrix.to/#/someroom/someevent\">In reply to</a> <a href=\"https://matrix.to/#/@alice:tprai.org\">@alice:tprai.org</a><br><h1>Heading with <badtag>invalid</badtag> content</h1></blockquote></mx-reply>This is a reply.";
...
- (void)testRenderHTMLStringWithImageHandler
{
    ...
    NSURL *imageURL = [NSURL URLWithString:@"https://tprai.org/images/matrix-logo.svg"];
...
{
    NSString *s = @"Matrix HQ room is at #matrix:tprai.org.";
    NSAttributedString *as = [eventFormatter renderString:s forEvent:anEvent];

    NSRange linkRange = [s rangeOfString:@"#matrix:tprai.org"];
...
{
    NSString *s = @"Matrix HQ room is at https://matrix.to/#/room/#matrix:tprai.org.";
    NSAttributedString *as = [eventFormatter renderString:s forEvent:anEvent];
...
- (void)testUserDisplayNameFromEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:tprai.org\",\"content\":{\"displayname\":\"bob\",\"membership\":\"invite\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:tprai.org\",\"room_id\":\"!foofoofoofoofoofoo:tprai.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
...
- (void)testUserDisplayNameFromNonMembershipEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:tprai.org\",\"content\":{\"ciphertext\":\"foo\",\"sender_key\":\"bar\",\"device_id\":\"foobar\",\"algorithm\":\"m.megolm.v1.aes-sha2\"}},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:tprai.org\",\"room_id\":\"!foofoofoofoofoofoo:tprai.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.encrypted\",\"unsigned\":{}}"];
...
- (void)testUserAvatarUrlFromEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:tprai.org\",\"content\":{\"displayname\":\"bob\",\"avatar_url\":\"mxc://foo.bar\",\"membership\":\"join\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:tprai.org\",\"room_id\":\"!foofoofoofoofoofoo:tprai.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
...
- (void)testUserAvatarUrlFromEventWithNonMXCAvatarUrlContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:tprai.org\",\"content\":{\"displayname\":\"bob\",\"avatar_url\":\"http://foo.bar\",\"membership\":\"join\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:tprai.org\",\"room_id\":\"!foofoofoofoofoofoo:tprai.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
