...
final class MarkdownToHTMLRendererTests: XCTestCase {
    ...
    func testRenderAutolinks() {
        let input = [
            "Test1:",
            "<#_foonetic_xkcd:tprai.org>",
            "<http://google.com/_thing_>",
            "<https://tprai.org/_matrix/client/foo/123_>",
            "<#_foonetic_xkcd:tprai.org>",
            "",
            "Test1A:",
            "<#_foonetic_xkcd:tprai.org>",
            ...
            "",
            "Test3:",
            "<https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org>",
            "<https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org>",
        ].joined(separator: "\n")
        let expectedOutput = [
            "<p>Test1:\n&lt;#_foonetic_xkcd:tprai.org&gt;\n<a href=\"http://google.com/_thing_\">http://google.com/_thing_</a>\n<a href=\"https://tprai.org/_matrix/client/foo/123_\">https://tprai.org/_matrix/client/foo/123_</a>\n&lt;#_foonetic_xkcd:tprai.org&gt;</p>",
            "<p>Test1A:\n&lt;#_foonetic_xkcd:tprai.org&gt;\n<a href=\"http://google.com/_thing_\">http://google.com/_thing_</a>\n<a href=\"https://tprai.org/_matrix/client/foo/123_\">https://tprai.org/_matrix/client/foo/123_</a>\n&lt;#_foonetic_xkcd:tprai.org&gt;</p>",
            ...
            "<p>Test3:\n<a href=\"https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org\">https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org</a>\n<a href=\"https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org\">https://riot.im/app/#/room/#_foonetic_xkcd:tprai.org</a></p>",
            "",
        ].joined(separator: "\n")
    ...
    func testRenderRepairedLinks() {
        ...
        let expectedOutput = [
            ...
            "<p>Test3:\nhttps://riot.im/app/#/room/#_foonetic_xkcd:tprai.org\nhttps://riot.im/app/#/room/#_foonetic_xkcd:tprai.org</p>",
            "",
        ].joined(separator: "\n")
        testRenderHTML(input: input, expectedOutput: expectedOutput)
    }
    ...
    func testRenderRepairedLinksWithCharactersRequiringPercentEncoding() {
        ...
        + "https://matrix.to/#/#_oftc_#matrix-dev:tprai.org"
        + " "
        + "https://matrix.to/#/#?=+-_#_"
        + "\n"
    ...
    func testRenderLinksInCodeblock() {
        ...
        + "```"
        let expectedOutput = [
            "<pre><code class=\"language-Test1:\">#_foonetic_xkcd:tprai.org",
            "http://google.com/_thing_",
            "https://tprai.org/_matrix/client/foo/123_",
            "#_foonetic_xkcd:tprai.org",
            "",
