...
public class VectorL10n: NSObject {
  ...
  /// I'd like to chat with you with matrix. Please, visit the website http://tprai.org to have more information.
  ...
  /// Matrix provides identity servers to track which emails etc. belong to which Matrix IDs. Only https://tprai.org currently exists.
  ...
  /// Matrix ID (e.g. @bob:tprai.org or bob)
